...
const reminderDateInput = document.getElementById('reminder-date') as HTMLInputElement;
...
const exportTasksButton = document.getElementById('export-tasks') as HTMLButtonElement;
...
function displayTasks() {
    ...
    filteredTasks.forEach(task => {
        ...
        const addSubTaskButton = taskItem.querySelector('.add-sub-task') as HTMLButtonElement;
        const removeTaskButton = taskItem.querySelector('.remove-task') as HTMLButtonElement;

        addSubTaskButton.addEventListener('click', () => {
            const subTaskText = prompt('Enter sub-task:');
            if (subTaskText) {
                const newSubTask: SubTask = { text: subTaskText, progress: 0 };
        ...
        const subTaskList = taskItem.querySelector('.sub-task-list') as HTMLUListElement;
        ...
        task.subTasks.forEach(subTask => {
            ...
            const subTaskInput = subTaskItem.querySelector('.sub-task-input') as HTMLInputElement;
            const progressInput = subTaskItem.querySelector('input[type="range"]') as HTMLInputElement;
